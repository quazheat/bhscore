    ...
    public aez() {
        ...
        hj hhg = new hj(
                """
                        ...
                        2) Скорость работы программы — меняется ТОЛЬКО после перезапуска.
                        ...
                        Если у вас нет этих модов, значит у вас не полный доступ.
                        ...
                        Кнопка ignore создана для списка имен игроков, которые нарушают правила проекта,
                        например ПРИВЕТВСЕМАААААААААААА, но за это не всегда мутят,
                        поэтому добавляйте такие имена в список игнора, ЕСЛИ КТО-ТО НАПИШЕТ ЕГО В ЧАТЕ,
                        программа не будет считать это нарушением.
                        """);
